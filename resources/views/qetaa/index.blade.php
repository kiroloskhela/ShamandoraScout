...
<div class="container mx-auto px-4 py-8">
     <x-data-table :data="$qetaat ? $qetaat->toArray() : []" title="إدارة القطاعات الكشفية" :add-button="[
            ...
            [
                'name' => 'tree',
                'label' => 'شجرة',
                'route' => route('qetaa.tree') . '?id=:id',
                'idField' => 'QetaaID',
                'cssClass' => 'inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 ml-2'
            ],
            [
                'name' => 'edit',
                'label' => 'تعديل',
