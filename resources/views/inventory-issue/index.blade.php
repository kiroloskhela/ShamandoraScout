...
@section('content')
    <div class="container mx-auto px-4 py-8" dir="rtl">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-8 border-2 border-green-300">
            <h3>الأصناف</h3>
            <input type="text" id="itemSearch" placeholder="ابحث عن الصنف"
                class="w-full border rounded p-2 text-right mb-2" autocomplete="off">
        ...
        <div class="text-center mb-6">
            <button type="button" id="generatePdf"
                class="px-8 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600">تحميل الـ PDF</button>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                matches.forEach(item => {
                    ...
                    div.textContent = item.ItemName + ' (الحد الأقصى: ' + (item.ItemQuantity ||
                        10) + ')';
