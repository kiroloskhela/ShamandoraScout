...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <x-data-table :data="$locations->toArray()" :title="__('Manage places')" :add-button="[
            'label' => __('Add area'),
            'route' => route('locations.create'),
            'cssClass' =>
            ...
            [
                'name' => 'delete',
                'label' => __('Delete'),
                'route' => route('locations.deletes', ':id'),
                'idField' => 'LocationID',
                'cssClass' =>
