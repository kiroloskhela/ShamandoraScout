                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">تعديل ايجازة بطاقة قدم</h6>
                        </div>
                    </div>

                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('betaka.update', $betakat->EgazetBetakatTaqaddomID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                <label>ID = {{$betakat->EgazetBetakatTaqaddomID}}</label>
                                                <input type="text" class="form-control form-control-user" name="betaka_name" id="betaka_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                                    placeholder="ادخل اسم فصيلة الدم" onfocusout="myFunction()" value="{{$betakat->EgazetBetakatTaqaddomName}}">
                                                    <br>
