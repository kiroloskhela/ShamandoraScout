...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        @endif
        <x-data-table :data="$folars->toArray()" :title="__('Manage scout scarves')" :add-button="[
            'label' => __('Add new scout scarf'),
            'route' => route('folar.create'),
            'cssClass' =>
                'bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200',
        ]" :columns="[
            [
                'key' => 'FolarID',
                'label' => __('Scout scarf ID'),
                'type' => 'text',
                'cssClass' => 'text-sm text-gray-900 font-medium',
            ],
            [
                'key' => 'FolarName',
                'label' => __('Scout scarf name'),
                'type' => 'label',
