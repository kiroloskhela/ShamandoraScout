                                ...
                                <form class="user" id="regForm" method="POST"
                                    ...
                                    <div class="card-header py-3">
                                        <div class="">
                                            ...
                                            <select class="form-control" style="margin-top: 8px;" name="qetaa_id"
                                                id="qetaa_id" onselect="" placeholder="اختار القطاع الكشفي">
                                                <option
                                                    style="font-family: 'Cairo', sans-serif; color: black; font-size: large"
                                                    value="" disabled selected> اختر القطاع الكشفي</option>
                                            ...
                                            <input type="submit" class="btn-google btn-user btn-block"
                                                ...
                                                value="تأكيد ادخال السؤال"></input>
                                        </div>
                                    </div>
                                </form>
                            </div>
