@extends('layouts.app', ['pageTitle' => __('Add new game')])

@section('content')
    <div class="flex justify-center px-4 py-8">
        <div class="w-full max-w-2xl rounded-2xl border border-blue-200 bg-white p-8 shadow-lg" dir="rtl">
            <div class="mb-6 text-center">
                <h2 class="text-2xl font-bold text-gray-800">{{ __('Add new game') }}</h2>
                <p class="mt-2 text-sm text-gray-500">{{ __('Enter the game details clearly and in an organized way') }}</p>
            </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="title" name="title" required
                            ...
                            placeholder="{{ __('Enter game title') }}" value="{{ old('title') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" required rows="4"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter game description') }}">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="rules" name="rules" rows="3"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter game rules') }}">{{ old('rules') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="point_system" name="point_system" rows="3"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter points system') }}">{{ old('point_system') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="age_group" name="age_group"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter age group') }}" value="{{ old('age_group') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="target" name="target"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter the game objective') }}" value="{{ old('target') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="require_custody" name="require_custody" rows="3"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter required custody items') }}">{{ old('require_custody') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="reference_link" name="reference_link"
                            class="w-full rounded-xl border border-slate-200 px-4 py-3 text-right text-slate-700 focus:border-blue-500 focus:outline-none"
                            placeholder="{{ __('Enter reference link') }}" value="{{ old('reference_link') }}">
                    </div>

                    <div class="flex justify-center pt-2">
                        <button type="submit"
                            class="inline-flex h-12 items-center justify-center rounded-full bg-blue-600 px-8 text-sm font-medium text-white transition hover:bg-blue-700">{{ __('Add game') }}</button>
                    </div>
                </div>
            </form>
        </div>
