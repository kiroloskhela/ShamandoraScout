                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <div class="form-group text-center" dir="rtl">
                                        <label for="joindate" style="font-family: 'Cairo', sans-serif;">نوع
                                            الملتحق</label>
                            ...
                            <div class="p-5">
                                ...
                                <div class="form-group row" dir="rtl">
                                    <label for="has_whatsapp"
                                        style="font-family: 'Cairo', sans-serif; margin-top: 5px;">هل
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    ...
                                    @if ($person->JobName == null)
                                        <input dir="rtl" type="text" name="person_job_place"
                                            id="person_job_place" class="form-control form-control-user"
                                            style="font-family: 'Cairo', sans-serif; font-size: large" value="لا يوجد"
                                            disabled>
                                    @else
                                        <input dir="rtl" type="text" name="person_job_place"
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    ...
                                    @if ($person->ActualFacultyGraduationYear == null)
                                        <input dir="rtl" type="text" name="university_grad_year"
                                            id="university_grad_year" class="form-control form-control-user"
                                            style="font-family: 'Cairo', sans-serif; font-size: large" value="لا يوجد"
                                            disabled>
                                    @else
                                        <input dir="rtl" type="text" name="university_grad_year"
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    <label class="text-center" for="v"
                                        style="font-family: 'Cairo', sans-serif;">اسم الأب
                                        الروحي</label>
