            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <div class="form-group row" dir="rtl">
                                    <div class="col-sm-3 mb-3 mb-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="person_id"
                                            id="person_id" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="password"
                                            id="password" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="shamandora_code"
                                            id="shamandora_code"
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="gender" id="gender"
                                        style="font-family: 'Cairo', sans-serif; font-size: medium" placeholder="النوع"
                                        value="ذكر" disabled>
                                    @else
                                    <input type="text" class="form-control form-control-user" name="gender" id="gender"
                                        style="font-family: 'Cairo', sans-serif; font-size: medium" placeholder="النوع"
                                ...
                                <div class="form-group row text-center" dir="rtl">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="date" class="form-control form-control-user" id="birthdate_input"
                                ...
                                <br>
                                <div class="form-group text-center" dir="rtl">
                                    <label for="facebookLink" style="font-family: 'Cairo', sans-serif;">Facebook Account
                                        URL/Link</label>
                                    ...
                                    <input dir="rtl" type="text" class="form-control form-control-user"
                                        ...
                                        style="font-family: 'Cairo', sans-serif; font-size: large"
                                        placeholder="أدخل لينك حساب الفيسبوك الخاص بالمتلحق (إن وُجِد)" value="لا يوجد"
                                        disabled>
                                    @else
                                    <input dir="rtl" type="text" class="form-control form-control-user"
                                        name="inputFacebookLink" id="inputFacebookLink"
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    <label for="joindate" style="font-family: 'Cairo', sans-serif;">فصيلة
                                        الدم</strong></label>
                                    <input dir="rtl" type="text" class="form-control form-control-user" name="bloodtype"
                                        id="bloodtype" style="font-family: 'Cairo', sans-serif; font-size: large"
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4" style="font-family: 'Cairo', sans-serif;"> عرض بيانات
                                    ملتحق</h1>
                                <h2 class="h4 mb-4" style="font-family: 'Cairo', sans-serif; color: brown;"> الجزء
                            ...
                            <div class="form-group row" dir="rtl">
                                ...
                                <input type="text" class="form-control form-control-user" name="has_whatsapp"
                                    ...
                                    value="{{$person->IsOPersonalPhoneNumberHavingWhatsapp==True?"نعم":"لا"}}" disabled>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <div class="form-group text-center" dir="rtl">
                                ...
                                @if($person->JobName==null)
                                <input dir="rtl" type="text" name="person_job" id="person_job"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large" value="لا يوجد" disabled>
                                @else
                                <input dir="rtl" type="text" name="person_job" id="person_job"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large"
                            ...
                            <div class="form-group text-center" dir="rtl">
                                ...
                                <input dir="rtl" type="text" name="person_job_place" id="person_job_place"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large"
                                    value="{{$person->WorkPlace}}" disabled>
                                @endif
                            </div>
                            </br>
                            <div class="form-group text-center" dir="rtl">
                            ...
                            <div class="form-group text-center" dir="rtl">
                                ...
                                @if($person->FacultyName==null)
                                <input dir="rtl" type="text" name="faculty_name" id="faculty_name"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large" value="لا يوجد" disabled>
                                @else
                                <input dir="rtl" type="text" name="faculty_name" id="faculty_name"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large"
                                    value="{{$person->FacultyName}}" disabled>
                                @endif
                            </div>
                            </br>
                            <div class="form-group text-center" dir="rtl">
                                ...
                                @if($person->UniversityName==null)
                                <input dir="rtl" type="text" name="university_name" id="university_name"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large" value="لا يوجد" disabled>
                                @else
                                <input dir="rtl" type="text" name="university_name" id="university_name"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large"
                                    value="{{$person->UniversityName}}" disabled>
                                @endif
                            </div>
                            </br>
                            <div class="form-group text-center" dir="rtl">
                                ...
                                @if($person->ActualFacultyGraduationYear==null)
                                ...
                                <input dir="rtl" type="text" name="university_grad_year" id="university_grad_year"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large"
                                    value="{{$person->ActualFacultyGraduationYear}}" disabled>
                                @endif
                            </div>
                            </br>
                            <hr>
                            <div class="form-group text-center" dir="rtl">
                                <label class="text-center" for="v" style="font-family: 'Cairo', sans-serif;">اسم الأب
                                    الروحي</label>
                        ...
                        <div class="p-5">
                            ...
                            <div class="form-group text-center" dir="rtl">
                                ...
                                <input dir="rtl" type="text" name="spiritual_father_church" id="spiritual_father_church"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large" placeholder=""
                                    value="{{$person->RotbaName}}" disabled>
                            </div>
                            <div class="form-group text-center" dir="rtl">
                                ...
                                <input dir="rtl" type="text" name="spiritual_father_church" id="spiritual_father_church"
                                    class="form-control form-control-user"
                                    style="font-family: 'Cairo', sans-serif; font-size: large" placeholder=""
                                    value="{{$person->EgazetBetakatTaqaddomName}}" disabled>
                            </div>
                            <div class="form-group text-center" dir="rtl">
