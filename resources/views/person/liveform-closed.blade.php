...
<head>
    ...
    @include('partials.seo-head', [
        'seoTitle' => __('Registration closed | Shamandora Scout'),
        'seoDescription' => __('Shamandora Scout enrolment is currently closed. Official Egyptian Sea Scout group — الشمندوره البحريه.'),
