...
<head>
    ...
    <title>كشافة الشمندورة | التسجيل غير متاح</title>
                ...
                <div class="relative px-6 sm:px-10 py-10 border-b border-slate-200 bg-slate-50">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="mt-3 max-w-2xl text-sm sm:text-base leading-7 text-slate-600">
                            نأسف، تم الوصول إلى الحد الأقصى لعدد الطلبات المتاحة لهذه المرحلة / القطاع في الوقت الحالي.
                            يمكنك المحاولة لاحقًا أو التواصل مع المسؤولين لمعرفة موعد فتح التسجيل مرة أخرى.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-6 sm:p-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center">
                            ...
                            <h3 class="font-bold text-slate-900">السبب</h3>
                            <p class="mt-2 text-sm text-slate-600 leading-6">
                                العدد المتاح لهذه الفئة اكتمل.
                            </p>
                        </div>
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center">
                            ...
                            <h3 class="font-bold text-slate-900">ماذا أفعل الآن؟</h3>
                            <p class="mt-2 text-sm text-slate-600 leading-6">
                                يمكنك الانتظار حتى يتم فتح التسجيل مرة أخرى، أو التواصل مع المسؤولين لمعرفة المزيد عن
                                موعد فتح التسجيل أو إذا كان هناك أي استثناءات ممكنة.
                            </p>
                        </div>
                    ...
                    <div class="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 mb-8">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="font-bold text-amber-900">معلومة مهمة</h4>
                                <p class="mt-1 text-sm leading-6 text-amber-800">
                                    ظهور هذه الصفحة يعني أن النظام تحقق من الحد الأقصى المسموح به لهذه الفئة قبل
                                    استكمال التسجيل.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="mt-10 pt-6 border-t border-slate-200 text-center">
                        ...
                        <p class="text-sm font-bold text-indigo-700 mt-1">مجموعة الشمندورة الكشفية</p>
                    </div>
                </div>
            </div>
        </div>
