...
@section('content')
    ...
    <head>
        ...
        <title>كشافة الشمندورة - تعديل بيانات الملتحق</title>
                    ...
                    <div class="px-6 md:px-10 py-8 border-b border-slate-200 bg-slate-50">
                        <div class="flex flex-col items-center justify-center gap-4 text-center">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 mt-2">تعديل جميع البيانات المسجلة بنفس أسلوب صفحات الملتحقين الجدد
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-2">
                            <div class="rounded-2xl bg-slate-50 border border-slate-200 p-4">
                                <div class="flex items-center justify-between gap-3 mb-4">
                                    ...
                                    <div class="text-xs text-slate-500">يمكنك عرض الصور الحالية وتغييرها</div>
                                </div>
                                        ...
                                        <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                            ...
                                            @if ($personalUrl)
                                                <img src="{{ $personalUrl }}" alt="{{ __('Personal photo') }}"
                                                    class="w-full h-72 object-cover rounded-xl border border-slate-200 mb-4">
                                            @else
                                                <div
                                                    class="w-full h-72 rounded-xl border border-dashed border-slate-300 bg-slate-50 flex items-center justify-center text-slate-400 mb-4">
                                                    لا توجد صورة شخصية
                                                </div>
                                            @endif

                                            <input type="file" name="personal_image" accept="image/*"
                                                class="block w-full text-sm text-slate-700 file:mr-4 file:rounded-lg file:border-0 file:bg-blue-600 file:px-4 file:py-2 file:text-white hover:file:bg-blue-700">
                                        </div>
                                    </div>
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
                            <div class="flex items-start justify-between gap-4 mb-5">
                                <div>
                                    ...
                                    <p class="text-slate-500 mt-1 text-sm">تعديل البيانات الأساسية للملتحق.</p>
                                </div>
                                <span
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
                            <div class="flex items-start justify-between gap-4 mb-5">
                                <div>
                                    ...
                                    <p class="text-slate-500 mt-1 text-sm">تعديل أرقام التواصل والعنوان.</p>
                                </div>
                                <span
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                ...
                                <div class="md:col-span-4">
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">هل عليه واتساب؟</label>
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
                            <div class="flex items-start justify-between gap-4 mb-5">
                                <div>
                                    ...
                                    <p class="text-slate-500 mt-1 text-sm">تعديل البيانات التعليمية والكنسية.</p>
                                </div>
                                <span
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
                            <div class="flex items-start justify-between gap-4 mb-5">
                                <div>
                                    ...
                                    <p class="text-slate-500 mt-1 text-sm">تعديل بيانات الرتبة والبطاقة والقطاع.</p>
                                </div>
                                <span
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                ...
                                <div class="md:col-span-4">
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">إجازة بطاقة
                                        التقدم</label>
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
                            <div class="flex items-start justify-between gap-4 mb-5">
                                <div>
                                    ...
                                    <p class="text-slate-500 mt-1 text-sm">عرض الأسئلة مع إمكانية تعديل الإجابات المسجلة.
                                    </p>
                                </div>
                                <span
