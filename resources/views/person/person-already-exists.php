...
<head>
    ...
    <title>كشافة الشمندورة - غير مسموح الدخول</title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div style="margin-top: 10em">
                            ...
                            <div class="text-center">
                                <h2 class="h4 mb-4" style="font-family: 'Cairo', sans-serif; color: brown;"> هذا الشخص
                                    موجود بالفعل على النظام، من فضلك تأكد من البيانات التي تقوم بادخالها
                                </h2>
                            </div>
                            <hr>
