            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="season_event_id" name="season_event_id"
                        class="w-full h-12 ps-4 border rounded-lg border-slate-200 dark:border-slate-700 dark:bg-slate-900 focus:border-blue-500 focus:outline-none"
                    ...
                    @if (($seasonId ?? null) && $events->isEmpty())
                        <p class="mt-2 text-xs text-amber-600 dark:text-amber-400">{{ __('No reservation events with a finance plan in this season.') }}</p>
                    @endif
                </div>
            </div>
        </form>
