            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <form class="user" id="regForm" method="post"
                        action="{{ route('blood.update', $blood->BloodTypeID) }}">
                        @method('PATCH')
                        @csrf
                        <div class="card-header py-3">
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>ID = {{ $blood->BloodTypeID }}</label>
                                <input type="text" class="form-control form-control-user" name="blood_name"
                                    id="blood_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                    placeholder="ادخل اسم فصيلة الدم" onfocusout="myFunction()"
                                    value="{{ $blood->BloodTypeName }}">
                                <br>
